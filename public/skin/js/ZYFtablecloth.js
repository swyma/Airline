...
this.tablecloth = function() {
	...
	// if set to true then mouseover a table cell will highlight entire column
	// (except sibling headings)
	var highlightCols = false;

	// if set to true then mouseover a table cell will highlight entire row
	// (except sibling headings)
